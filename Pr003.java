class Pr003 {
	public static void main(String args[]) {
		...
		short short_var;
		System.out.println("Тип данных short имеет разрядность 16 бит и значения от -32768 до 32787");
		...
		//Вычисление длины гипотенузы при помощи метода Math.sqrt
		double a = 3.0, b = 4.0;
		...
		int_var = 0xFF; //Шестнадцатиричный формат числа

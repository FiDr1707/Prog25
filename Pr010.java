...
class Pr010 {
	public static void main (String args[]){
		...
		//Символы и строки несовместимы в качестве типов данных
		int a = 3355;
		...
		String str6 = new String("Строка 6"); //Создание строки с помощью оператора new
		...
		if (str6.compareTo(str7) > 0)
			...
			(str6.compareTo(str7) < 0)
			System.out.println("str6 меньше, чем str7");
		else 
			System.out.println("str6 равнa str7");
		...
		System.out.println("Индекс первого вхождения подстроки: " + str1.indexOf("строка"));
		 ...
		 str8 = "Строка, строка, строка и строка. 4 сллова \"строка\"";
		 System.out.println("Индекс первого вхождения подстроки: " + str1.lastIndexOf("строка"));
	}
}

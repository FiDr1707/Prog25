...
class Pr009 {
	public static void main(String args[]) {
		...
		MyClass2 t4 = new MyClass2(38);

		System.out.println("Значение х внутри t3: " + t3.x + "\nЗначение x внутри t4: " + t4.x);

		Auto bmw = new Auto(5, 80, 12.5);
		Auto merc = new Auto(2, 60, 10.5);

		System.out.println("BMW X5 перевозит " + bmw.pass + " пассажиров на " + bmw.range() + " км");

		
		System.out.println("Mercedes SLC перевозит " + merc.pass + " пассажиров на " + merc.range() + " км");
...
//Определение максимального и минимального значения в массиве
		...
		System.out.println();
		int sample3[] = {1,-51,-24,-66,88,12,35,11,16,2,-212};
		...
		nums2 = nums1; //Обе переменные ссылаются на объект, на который ссылалась переменная nums1
